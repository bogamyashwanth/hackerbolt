/*
  ...
  1. New Tables
    - `admin_auth_settings`
      - Stores admin authentication configuration
      - Includes password hash, MFA settings, and password change requirements
    
  2. Functions
    - `check_admin_email`: Validates admin email
    - `verify_admin_password`: Validates password requirements
    - `update_admin_password`: Handles password updates
